function [C1, C2]=produce_n_mode_set(N_mode, l, m_minmax_c1, m_minmax_c2, cov_minmax_c1, cov_minmax_c2, diag_cov, N1_minmax, N2_minmax)
    ...
    for i=1:N_mode
        ...
        N2_per_mode = [N2_per_mode, floor(N2/N_mode)];
        if i==N_mode
    ...
    for i=1:length(N1_per_mode)
        [m1, cov1] = produce_m_and_cov(l, m_minmax_c1, cov_minmax_c1, true, 1);
        C1 = [C1; mvnrnd(m1, cov1, N1_per_mode(i))];
    end

    for i=1:length(N2_per_mode)
        [m2, cov2] = produce_m_and_cov(l, m_minmax_c2, cov_minmax_c2, true, 1);
